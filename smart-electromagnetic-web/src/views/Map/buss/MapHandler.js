...
export function getTdtVector() {
	return new Cesium.WebMapTileServiceImageryProvider({
		url: "http://t0.tianditu.gov.cn/vec_w/wmts?tk=" + config.Tdtkey,
		layer: "vec",
		style: "default",
		tileMatrixSetID: "w",
		format: "tiles",
...
export function getTdtVectorLabel() {
	return new Cesium.WebMapTileServiceImageryProvider({
		url: "http://t{s}.tianditu.gov.cn/cva_w/wmts?tk=" + config.Tdtkey,
...
export function getTdtImage() {
	return new Cesium.WebMapTileServiceImageryProvider({
		url: "http://t{s}.tianditu.gov.cn/img_w/wmts?tk=" + config.Tdtkey,
		subdomains: ['0','1','2','3','4','5','6','7'],
		layer: "img",
		style: "default",
		tileMatrixSetID: "w",
...
export function getTdtImageLabel() {
	return new Cesium.WebMapTileServiceImageryProvider({
		url: "http://t{s}.tianditu.gov.cn/cia_w/wmts?tk=" + config.Tdtkey,
		subdomains: ['0','1','2','3','4','5','6','7'],
		layer: "cia",
		style: "default",
		tileMatrixSetID: "w",
...
//添加实体对象
export function SetEntity(entity, viewer, replace = true) {
