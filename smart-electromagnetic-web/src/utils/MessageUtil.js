 ...
 * @param {number} duration 显示时间, 默认1500毫秒。设为 0 则不会自动关闭
 */
 ...
 */
function messageBoxConfirm(content = '', title = '提示',confirmButtonText = '确定', cancelButtonText = '取消', confirmCallBack, cancelCallBack) {
